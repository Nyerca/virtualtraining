<template>
  ...
  <div class="main">
    <div class="row">
	  ...
	  <div class="profile">
		  <div class="level-border level-border-90">
			  </div>
			  <img class="img-summoner" src="http://www.menshairstyletrends.com/wp-content/uploads/2015/01/Cool-Hairstyles-2015-David-Beckham.jpg" alt="">
		  ...
		  <div class="profile-level">
			105
								...
								<div style="width:200px;height:200px;position:relative;border-radius:50%;margin:50px" 	data-knob-percentage="75"
															data-knob-timing="2"
															data-knob-image="http://www.menshairstyletrends.com/wp-content/uploads/2015/01/Cool-Hairstyles-2015-David-Beckham.jpg"
															data-knob-dotimage="http://images.clipartpanda.com/clipart-star-RTA9RqzTL.png"
															data-knob-gradient1="#FFD700"
															data-knob-gradient2="red"
															data-knob-dotcolor="#f00"
															data-knob-color="#efefef"
															class="iesknob"></div>
							</div>
							Lv. 8
							<div class="progressbar" data-perc="100" max="1000">
								<div class="bar"><span></span></div>
								<div class="label"><span></span></div>
								<div class="label2"><span></span><div class="tot">44</div></div>
							</div>
							Exp: 75/100
    ...
    <div class="row">
      <div class="data1">
        ...
        <div class="timeline timeline-alternating timeline-collapsing gray-blue">
      ...
      <div class="data2">
        <div class="card mdl-card">
          <div class="mdl-card__title">
            <h2 class="mdl-card__title-text">User Information</h2>
          </div>
          <div class="mdl-card__supporting-text">
            <form action="#">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			  <label  for="sample1">Username</label>
                <input type="text" id="sample1" value="Ricardo">


              </div>
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="password" id="sample1" value="password">
                <label class="mdl-textfield__label" for="sample1">Password</label>
              </div>
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="sample1" value="ricardo@example.com">
          ...
          <div class="mdl-card__title">
            <h2 class="mdl-card__title-text">Achievements Details</h2>
          </div>
          <div class="mdl-card__supporting-text">
            ICON


			<div id="flip-toggle" v-bind:class="'' + classApplied" @click="toggleClass()">
			  <div class="flipper">
				<div class="front">
			...
			<g>
				...
				<!-- back content -->
				  <div class="content">
					...
					<p>You did the first exercise.</p>
				  </div>
				</div>
			  </div>
			</div>
...
export default class User extends Vue {
  classApplied :string = "flip-container";
  ...
  toggleClass() {
    if(this.classApplied == "flip-container") {
      this.classApplied = "flip-container flip"
    }
    else {
      this.classApplied = "flip-container"
    }
  }
...
.level-border-30 {
    background-image: url( https://vignette.wikia.nocookie.net/leagueoflegends/images/c/c0/Level_50_Summoner_Icon_Border.png/revision/latest?cb=20180324105839 );

}

.level-border-60 {
    /*background-image: url( https://vignette.wikia.nocookie.net/leagueoflegends/images/9/9f/Level_475_Summoner_Icon_Border.png/revision/latest?cb=20180406054805 );*/
	background-image: url( ../assets/border1.png);
	}

.level-border-90 {
    background-image: url( https://vignette.wikia.nocookie.net/leagueoflegends/images/2/2e/Level_500_Summoner_Icon_Border.png/revision/latest?cb=20180406054832 );
}
